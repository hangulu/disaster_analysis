...
northeast_storms$total_energy_prod <- t(tepr_agg[tepr_agg$region == "california",22:58])
northeast_storms$renew_energy_prod <- t(repr_agg[repr_agg$region == "california",22:58])

midwest_storms$total_energy_prod <- t(tepr_agg[tepr_agg$region == "california",22:58])
midwest_storms$renew_energy_prod <- t(repr_agg[repr_agg$region == "california",22:58])

south_storms$total_energy_prod <- t(tepr_agg[tepr_agg$region == "california",38:58])
south_storms$renew_energy_prod <- t(repr_agg[repr_agg$region == "california",38:58])
